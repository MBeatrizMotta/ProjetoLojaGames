...
import com.mundodosgames.mundodosgames.repository.CategoriasRepository;
...
public class CategoriasController {
	...
	@Autowired
	public CategoriasRepository categoriaRepository;
	...
	public ResponseEntity<List<CategoriasModel>> getByTitle(@PathVariable String plataforma){
	...
	@PutMapping
	public ResponseEntity<CategoriasModel> put(@Valid @RequestBody CategoriasModel categoria){
